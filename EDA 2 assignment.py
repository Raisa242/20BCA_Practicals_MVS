...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 10 22:48:35 2022
...
mydata=pd.read_csv("/Users/yuvraj/Desktop/Jk practicals /heart.csv")
print(mydata.shape)
print(mydata.head(10))
mydata.info()
print(mydata.describe())
df_desc=pd.DataFrame(mydata.describe())
df_desc.to_csv("/Users/yuvraj/Desktop/Jk practicals /describe.csv")
